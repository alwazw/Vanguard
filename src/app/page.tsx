    ...
    <main className="min-h-screen bg-deep-black">
      ...
      <section className="h-screen bg-deep-black flex items-center justify-center p-12 border-y border-white/5 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5 pointer-events-none"
             style={{backgroundImage: 'radial-gradient(#B6FF3B 0.5px, transparent 0.5px)', backgroundSize: '40px 40px'}} />

        <div className="max-w-5xl text-center relative z-10">
            <span className="text-neon-lime font-mono text-sm tracking-[0.5em] uppercase mb-8 block animate-pulse">Theoretical Framework</span>
