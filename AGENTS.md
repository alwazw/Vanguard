...
​Styling: Tailwind CSS v4. Use a Dark Theme with Neon Lime (#B6FF3B) and Vanguard Blue (#3B7BFF) accents.
​Components: Functional components only. Use Shadcn UI for primitives with high-precision, sharp edges.
​Animations: Use GSAP with ScrollTrigger for all scroll-driven effects. Use Lenis for smooth scrolling. 
​Narrative: "Cyber-industrial" precision, holistic security convergence, and high-fidelity motion.
​Workflow Rules
